...
export class QuickActionsTreeProvider implements vscode.TreeDataProvider<QuickActionItem> {
  ...
  public async getChildren(element?: QuickActionItem): Promise<QuickActionItem[]> {
    ...
    return [
      ...
      {
        id: "browse_library",
        label: "Browse Library (500)",
        description: "Ctrl+Shift+D",
        tooltip: "Search and browse 500 components across 7 domains",
        icon: "library",
      ...
      },
      {
        ...
        tooltip: "Fuzzy search with relevance scoring across all 500 components",
        icon: "search",
