...
export function generateCompetitiveProgrammingComponents(): Component[] {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program testing high-speed buffered integer I/O",
...
int main(void) {
  ...
  // 2. prog_cp_coordinate_compression
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program sorting and mapping coordinates to dense ranks",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program testing popcount, lowest set bit, and powers of two",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["competitive-programming", "bit-manipulation", "full-program"],
      aliases: ["prog_cp_bitwise_tricks"],
    })
  );

  // 4. prog_cp_bitmasking
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program enumerating all submasks of a bitmask",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program computing primes and prime factorizations",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program computing modular exponentiation and inverse",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program precomputing factorials and querying nCr modulo 1e9+7",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  // 8. prog_cp_matrix_exponentiation
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program calculating N-th Fibonacci via 2x2 matrix fast power",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program answering 1D and 2D prefix sum range queries",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program applying O(1) range updates and generating final array",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program demonstrating two pointers: pair sum and trapping water",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program executing fixed and variable sliding windows",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program executing point updates and range queries on a Fenwick tree",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program executing range minimum queries and point updates",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program executing DSU unions and detecting cycle connections",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["competitive-programming", "dsu", "full-program"],
      aliases: ["prog_cp_disjoint_set"],
    })
  );

  // 16. prog_cp_monotonic_structures
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program computing next greater element with monotonic stack",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["competitive-programming", "monotonic-stack", "full-program"],
      aliases: ["prog_cp_monotonic_structures"],
    })
  );

  // 17. prog_cp_binary_search_answer
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program allocating workload across workers via binary search on answer",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program finding the maximum of a unimodal parabola via ternary search",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program solving shortest path on 0-1 weighted graph using deque BFS",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program finding tree Lowest Common Ancestors via binary lifting",
      signature: "int main(void);",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete competitive programming program finding strongly connected components using Tarjan algorithm",
      signature: "int main(void);",
      code: `#include <stdio.h>
