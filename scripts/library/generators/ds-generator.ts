...
int open_hash_insert(OpenHashTable* ht, const char* key, int value) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete 1D array operations program (reverse, rotate, min, max, binary search)",
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete 2D matrix dynamic allocation and transpose program",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete 3D tensor allocation, indexing, and slice printing program",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete auto-resizing dynamic array vector lifecycle program",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["program", "array", "vector", "dynamic-array"],
  ...
  components.push(
    createComponent({
      ...
      description: "Complete singly linked list program with insertions, deletions, search, min/max, count, and free",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete doubly linked list program with bidirectional printing and deletions",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      name: "prog_singly_circular_list",
      type: "program",
      category: "data-structures",
      subcategory: "linked-lists",
      ...
      description: "Complete singly circular linked list cycle insertion and traversal program",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
    ...
    return 0;
      ...
      aliases: ["prog_singly_circular_list", "programCircularList"],
    })
  );
  ...
  components.push(
    createComponent({
      ...
      name: "prog_doubly_circular_list",
      type: "program",
      category: "data-structures",
      subcategory: "linked-lists",
      ...
      description: "Complete doubly circular linked list forward and backward cycle traversal program",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
    ...
    return 0;
      ...
      aliases: ["prog_doubly_circular_list", "programDoublyCircularList"],
    })
  );
  ...
  components.push(
    createComponent({
      ...
      description: "Complete array-based stack program testing push, pop, peek, and capacity growth",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete linked node stack program with dynamic push and pop operations",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete program computing next greater element array using monotonic stack",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete linear FIFO queue program testing enqueue and dequeue",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete ring buffer circular queue program",
      signature: "int main(void)",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete double-ended queue program supporting front and rear operations",
      signature: "int main(void)",
      code: `#include <stdio.h>
...
int main(void) {
  ...
  // 15. Full Program: Priority Queue
  components.push(
    createComponent({
      ...
      description: "Complete binary min-heap priority queue program",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["program", "queue", "priority-queue", "heap"],
  ...
  components.push(
    createComponent({
      ...
      description: "Complete Binary Search Tree insertion and in-order traversal program",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete self-balancing AVL Tree insertion program with rotations",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["program", "tree", "avl"],
      aliases: ["prog_avl", "programAVL"],
    })
  );

  // 18. Full Program: Trie
  components.push(
    createComponent({
      ...
      description: "Complete prefix tree Trie program with insert, search, and prefix matching",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete iterative segment tree program with range sum queries and point updates",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["program", "tree", "segment-tree"],
      aliases: ["prog_segment_tree", "programSegmentTree"],
    })
  );

  // 20. Full Program: Graph Adjacency Matrix (with "graph" in name!)
  components.push(
    createComponent({
      ...
      description: "Complete graph program using 2D adjacency matrix with edge checks",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["program", "graphs", "adjacency-matrix", "graph"],
      aliases: ["prog_graph_adj_matrix", "programGraphAdjMatrix"],
    })
  );

  // 21. Full Program: Graph Adjacency List (with "graph" in name!)
  components.push(
    createComponent({
      ...
      description: "Complete graph program using dynamic adjacency lists",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["program", "graphs", "adjacency-list", "graph"],
      aliases: ["prog_graph_adj_list", "programGraphAdjList"],
    })
  );

  // 22. Full Program: Graph DSU (with "graph" in name!)
  components.push(
    createComponent({
      ...
      description: "Complete Disjoint Set Union program tracking connected components with path compression",
      signature: "int main(void)",
      code: `#include <stdio.h>
...
int main(void) {
    ...
    return 0;
      ...
      tags: ["program", "graphs", "dsu", "graph"],
      aliases: ["prog_graph_dsu", "programGraphDSU"],
    })
  );

  // 23. Full Program: Separate Chaining Hash Table
  components.push(
    createComponent({
      ...
      description: "Complete hash table program using separate chaining bucket lists",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void table_put(Table* t, const char* k, int v) {
...
int table_get(const Table* t, const char* k, int* v) {
    unsigned long b = hash(k);
...
int main(void) {
    Table t = {0};
    table_put(&t, "apples", 40);
    table_put(&t, "oranges", 85);
    table_put(&t, "bananas", 25);

    int val;
    if (table_get(&t, "oranges", &val)) {
        printf("Oranges quantity: %d\n", val);
    }
    return 0;
}`,
  ...
  // 24. Full Program: Open Addressing Hash Table
  components.push(
    createComponent({
      ...
      description: "Complete linear probing open addressing hash table program",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <string.h>
#include <stdbool.h>
...
int main(void) {
  ...
  components.push(
    createComponent({
      ...
      description: "Complete comparison program hashing strings with DJB2, FNV-1a, and SDBM",
      signature: "int main(void)",
      code: `#include <stdio.h>
#include <stdint.h>
